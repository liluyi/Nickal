...
namespace Platform.Core.Services
{
    ...
    public class OpenProjectArgs : DealRequstArgs
    {
        public readonly string BuildPluginToken;
        public AbstractProject project;
        public OpenProjectArgs(string FromToken, string BuildPluginToken, AbstractProject project)
            : base(FromToken, PluginRequstType.OpenProject)
        {
            this.BuildPluginToken = BuildPluginToken;
